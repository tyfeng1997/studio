...
This will help the system properly save and process your report. The report should be comprehensive, well-structured, and supported by data from your research tools. Ensure all analysis is based on the latest available data, clearly indicating data sources and timeframes.
`;
